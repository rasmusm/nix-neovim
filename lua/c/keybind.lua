...
function keybind.nmap(keys, command, options, name)
  keybind.bind_command(edit_mode.NORMAL, keys, command, options, name)
end

function keybind.vmap(keys, command, options, name)
  keybind.bind_command(edit_mode.VISUAL_SELECT, keys, command, options, name)
end
